        ...
        <Panel style={styles.contentPanel}>
          ...
          <View style={styles.contentGrid}>
            {contentEntries.slice(0, 3).map((entry) => (
              <Panel key={entry.id} style={[styles.contentCard, isCompact && styles.contentCardCompact]}>
...
const styles = StyleSheet.create({
  ...
  topbarRightCompact: { justifyContent: "flex-start" },
  ...
  heroCompact: { flexDirection: "column", gap: 24 }, 
  
  heroLeft: { flex: 1, minWidth: 320, gap: 14, justifyContent: "space-between" },
  heroLeftCompact: { minWidth: "100%", flex: 0 }, 
  ...
  heroVisualCompact: { minWidth: "100%", minHeight: 260, height: 260, flex: 0, borderRadius: 24, },
  ...
  contentCardCompact: { flexBasis: "100%" }, 
